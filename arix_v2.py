...
class ArixDexAPSStudio:
    ...
    {biru}By: {putih}t.me/apsstudiotech
    {biru}Discord: {putih}https://discord.gg/N9caefVJ7F
        ...
        print(banner)
        while True:
            ids = open("token.txt", "r").read().splitlines()
            list_countdown = []
